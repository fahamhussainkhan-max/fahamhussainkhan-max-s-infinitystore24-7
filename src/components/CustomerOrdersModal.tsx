  ...
  useEffect(() => {
    if (isOpen && initialOrderId && orders.length > 0) {
      const match = orders.find(
        (o) => o.id === initialOrderId || o.order_number === initialOrderId
      );
      if (match) {
                          ...
                          {filteredOrders.map((order) => {
                            ...
                            return (
                              <div
                                ...
                                className="p-4 rounded-2xl bg-white border border-gray-200 shadow-2xs hover:border-[#0A84FF]/60 hover:shadow-md transition-all cursor-pointer group active:scale-[0.99] select-none"
                              >
                                <div className="flex flex-wrap items-center justify-between gap-2 pb-3 border-b border-gray-100">
                                  <div>
                                    <div className="flex items-center gap-2">
                                      <span className="font-bold text-sm text-gray-900 font-mono group-hover:text-[#0A84FF] transition-colors">
                                ...
                                {/* Click to Track Live Timeline Action Bar */}
                                <div className="mt-3 pt-2.5 border-t border-gray-100 flex items-center justify-between text-xs">
                                  <span className="text-[11px] text-gray-500 font-medium flex items-center gap-1.5">
                                    ...
                                    <span>Click order to view visual timeline</span>
                                  </span>
                                  <span className="inline-flex items-center gap-1 font-bold text-[#0A84FF] group-hover:text-blue-700 transition-colors">
